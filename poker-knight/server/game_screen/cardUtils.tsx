...
export const dealRiverCards = (game: Game, caseNumber: number) => { // Function to deal river cards; case 1 deals 3, case 2 deals 1
...
export const resetCards = (game: Game) => { // Remove all cards from river and players, return to deck
    ...
    game.deckCards = [
        "spades_2", "spades_3", "spades_4", "spades_5", "spades_6", "spades_7", "spades_8", "spades_9", "spades_T", "spades_J", "spades_Q", "spades_K", "spades_A",
        "hearts_2", "hearts_3", "hearts_4", "hearts_5", "hearts_6", "hearts_7", "hearts_8", "hearts_9", "hearts_T", "hearts_J", "hearts_Q", "hearts_K", "hearts_A",
        "clubs_2", "clubs_3", "clubs_4", "clubs_5", "clubs_6", "clubs_7", "clubs_8", "clubs_9", "clubs_T", "clubs_J", "clubs_Q", "clubs_K", "clubs_A",
        "diamonds_2", "diamonds_3", "diamonds_4", "diamonds_5", "diamonds_6", "diamonds_7", "diamonds_8", "diamonds_9", "diamonds_T", "diamonds_J", "diamonds_Q", "diamonds_K", "diamonds_A"
    ];
}