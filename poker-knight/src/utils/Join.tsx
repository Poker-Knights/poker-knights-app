...
export const handleJoinPress = (socketRef: React.RefObject<any>, username: string, gameID: string) => {
    ...
    if (socketRef.current) {
      ...
      socketRef.current.emit('attemptToJoin', username, gameID);
    }
  };
...
export const handleGameJoined = (navigation: any, username: string) => (data: any) => {
